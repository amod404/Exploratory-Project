...
#
# Google Colab usage:
#   See the Colab notebook: NAS_Colab_Runner.ipynb
#   Or run: !python main.py  (after mounting/uploading the project folder)
# =============================================================================
...
def main():
    ...
    elif CFG.TARGET_DATASET == "TINY-IMAGENET" and CFG.BATCH_SIZE > 128:
        CFG.BATCH_SIZE = 128
